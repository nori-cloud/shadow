...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .app { font-size: 0.75rem; letter-spacing: 0.12em; text-transform: uppercase; color: #9a8e7e; margin-bottom: 0.25rem; }
    .title { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.75rem; font-weight: 300; margin-bottom: 0.25rem; }
    .date { font-size: 0.8125rem; color: #9a8e7e; margin-bottom: 2rem; }
    hr { border: none; border-top: 1px solid #e0d8cc; margin-bottom: 2rem; }
    .label { font-size: 0.7rem; letter-spacing: 0.1em; text-transform: uppercase; color: #c4985a; margin-bottom: 0.5rem; }
    .archetype { font-size: 1rem; font-weight: 400; margin-bottom: 1.5rem; }
    .insight { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.25rem; font-style: italic; font-weight: 300; line-height: 1.75; margin-bottom: 2rem; }
    .footer { font-size: 0.75rem; color: #c0b8aa; border-top: 1px solid #e0d8cc; padding-top: 1.5rem; }
  </style>
</head>
<body>
  <p class="app">The Shadow</p>
  <h1 class="title">Session Reflection</h1>
  <p class="date">${date}</p>
  <hr />
  <p class="label">Archetype</p>
  <p class="archetype">${archetypeName}</p>
  <p class="label">What emerged</p>
  <p class="insight">${insight}</p>
  <p class="footer">Generated by The Shadow</p>
